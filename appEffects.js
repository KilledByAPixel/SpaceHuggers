...
const sound_explosion =    [2,.2,72,.01,.01,.2,4,3.63,,,,,,1,,.5,.1,.5,.02];
const sound_checkpoint =   [,,700,,.04,.25,,2,,,373,.06,.08,.1,,,.07];
const sound_bulletHit =    [,,110,,,.01,,2.5];
const sound_rain =         [.02,,1e3,2,,2,,,,,,,,99];
const sound_wind =         [.01,.5,2e3,1,1,2,,,,,,,1,1,,,,,,.1];
